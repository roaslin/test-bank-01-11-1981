...
class TimeCheckerShould {
    ...
    public void return_true_for_a_transaction_older_than_60_seconds() {
        Transaction transaction = new Transaction(LocalDateTime.now().minusMinutes(5).toEpochSecond(UTC));
    ...
    public void return_false_for_a_transaction_no_older_than_60_seconds() {
        Transaction transaction = new Transaction(LocalDateTime.now().minusSeconds(5).toEpochSecond(UTC));
        TimeChecker timeChecker = new TimeChecker();
